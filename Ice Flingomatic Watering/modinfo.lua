...
{
    {
        ...
        hover = "Only target witherables when the weather is too hot.",
        options =
        {
    ...
    {
        name = "no_freeze_fffly",
        label = "Don't Freeze FFFly",
        hover = "Flingomatic snowballs won't freeze the friendly fruit fly.\n(They also won't extinguish it, unfortunately.)",
        options =
        {
            {description = "Disabled", data = false, hover = ""},
            {description = "Enabled", data = true, hover = "Snowballs ineffective."},
        },
        default = false,
    },
}
